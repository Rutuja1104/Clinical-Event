...
interface EventEHRCreateVisitDialogProps {
  isOpen: boolean;
...
}: EventEHRCreateVisitDialogProps) {
  return (
    <React.Fragment>
      <BootstrapDialog
      ...
      >
        ...
        <DialogContent dividers style={{ padding: "16px 24px 24px 24px" }}>
          <CreateVisitForm
            handleOnSubmittedData={(formData) => {
              console.log("Submitted fo111rm data:", formData);
            }}
          />
        </DialogContent>
      </BootstrapDialog>
